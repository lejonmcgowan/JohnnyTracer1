...
light_source {<-100, 10, 0> color rgb <1.5, 1.5, 1.5>}
...
finish {ambient 0.3 diffuse 0.8 specular 0.8 roughness 0.001 reflection 0.9}
}

plane {<0, 0, 1>, -4      
pigment {color rgb <0.0, 1.0, 1.0>}
finish {ambient 0.3 diffuse 0.8 specular 0.8 roughness 0.001 reflection 0.6}
}
